    ...
    <div id="wrapper">
        ...
        <div id="main-content">
            <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-8 col-sm-12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Doctor &nbsp; /&nbsp; Add Doctors</li>
                            </ul>
                        </div>
                ...
                <!-- Form filling starting  -->
              	<div class="row clearfix">
              		<div class="col-lg-12 col-md-12 col-sm-12">
              			<div class="card">
              				<div class="header">
              					<h2>Basic <span>Information</span>
              						<small>Full fillig from...</small>
              					</h2>
              				</div>
              				<div class="body">
              					<form action="/hospital/src/main/java/backend/DoctorAdd" method="Post">
              					<div class="row clearfix">
              						...
              						<div class="row clearfix mt-3">
              							<div class="col-sm-3">
              								<div class="form-group">
              									<input type="text" data-provid="datepicker" data-date-autoclose="true" class="form-control" placeholder="Date Of Birth" name="dob">
              								</div>
              							</div>
              							<div class="col-sm-3">
              								<div class="form-group">
              							...
              							<div class="col-sm-3">
              								<div class="form-group">
              									<input type="text" class="form-control" placeholder="specialist" name="specialist">
              								</div>
              							</div>
              							<div class="col-sm-3">
              								<div class="form-group">
              						...
              						<div class="row clearfix">
              							...
              							<div class="col-sm-6">
              								<div class="form-group">
              									<input type="text" class="form-control" placeholder="Website Url" name="webSiteUrl">
              								</div>
              							</div>
              						</div>
              						<div class="row clearfix">
              						...
              						<div class="row clearfix">
              							<div class="col-12">
              								<div class="form-group">
              									<textarea class="form-control" rows="5" cols="123" placeholder="Please enter what you want.." name="aboutDoctor">        									
              									</textarea>
              								</div>
              							</div>
              						</div>
              	<div class="row clearfix">
              		<div class="col-lg-12 col-md-12 col-sm-12">
              			<div class="card">
              				<div class="header">
              					<h2>Social <span>Media</span>
              						<small>Full filling URL...</small>
              					</h2>
              				</div>
              				<div class="body">
              					<div class="row clearfix">
	              						<div class="col-lg-6 col-md-6 col-sm-12">
	              							<div class="from-group">
												  ...
												  <input type="text" class="form-control" placeholder="LinkedIn" aria-label="Username" aria-describedby="basic-addon1" name="linkedIn">
												</div>
	              							</div>
	              						</div>
	              						<div class="col-lg-6 col-md-6 col-sm-12">
	              						...
	              						<div class="col-lg-6 col-md-6 col-sm-12">
	              							<div class="from-group">
	              								<div class="input-group mb-3">
												  <span class="input-group-text" id="basic-addon1">@</span>
												  <input type="text" class="form-control" placeholder="Twitter" aria-label="Username" aria-describedby="basic-addon1" name="twitter">
												</div>
	              							</div>
	              						</div>
	              						<div class="col-lg-6 col-md-6 col-sm-12">
	              							<div class="from-group">
	              								<div class="input-group mb-3">
												  <span class="input-group-text" id="basic-addon1">@</span>
												  <input type="text" class="form-control" placeholder="Instagram" aria-label="Username" aria-describedby="basic-addon1" name="intagram">
												</div>
	              							</div>
	              						</div>
	              					<div class="row clearfix">
	              						...
	              						<div class="col-lg-5">
	              							<div class="from-group">
	              								<div class="input-group mb-3">
	              									<input type="reset" value="Cancel" class="btn btn-black">
	              								</div>
	              							</div>
	              						</div>
	              					</div>
