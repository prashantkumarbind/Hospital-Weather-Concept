! function(e, t) {
    ...
    x.fn = x.prototype = {
        ...
        for ("boolean" == typeof s && (u = s, s = arguments[a] || {}, a++), "object" == typeof s || y(s) || (s = {}), a === l && (s = this, a--); a < l; a++)
            if (null != (e = arguments[a]))
                for (t in e) n = s[t], s !== (i = e[t]) && (u && i && (x.isPlainObject(i) || (r = Array.isArray(i))) ? (o = r ? (r = !1, n && Array.isArray(n) ? n : []) : n && x.isPlainObject(n) ? n : {}, s[t] = x.extend(u, o, i)) : void 0 !== i && (s[t] = i));
        return s
    }, x.extend({
    ...
    var d = function(n) {
        ...
        for (e in d = oe.support = {}, r = oe.isXML = function(e) {
                ...
                return i !== T && 9 === i.nodeType && i.documentElement && (s = (T = i).documentElement, C = !r(T), y !== T && (n = T.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", ie, !1) : n.attachEvent && n.attachEvent("onunload", ie)), d.attributes = le(function(e) {
                ...
                if ((e.ownerDocument || e) !== T && E(e), t = t.replace(Q, "='$1']"), d.matchesSelector && C && !D[t + " "] && (!a || !a.test(t)) && (!m || !m.test(t))) try {
                    var n = c.call(e, t);
        ...
        function we(d, p, g, m, v, e) {
            return m && !m[x] && (m = we(m)), v && !v[x] && (v = we(v, e)), ae(function(e, t, n, i) {
                var r, o, s, a = [],
                    l = [],
                    u = t.length,
                    c = e || function(e, t, n) {
        ...
        return me.prototype = b.filters = b.pseudos, b.setFilters = new me, p = oe.tokenize = function(e, t) {
            ...
            var n, m, v, y, _, i, r = [],
                ...
                s = D[e + " "];
            if (!s) {
                for (t || (t = p(e)), n = t.length; n--;)(s = Ee(t[n]))[x] ? r.push(s) : o.push(s);
        ...
        }, d.sortStable = x.split("").sort(A).join("") === x, d.detectDuplicates = !!u, E(), d.sortDetached = le(function(e) {
    ...
    (x.fn.init = function(e, t, n) {
        var i, r;
        if (!e) return this;
        if (n = n || I, "string" != typeof e) return e.nodeType ? (this[0] = e, this.length = 1, this) : y(e) ? void 0 !== n.ready ? n.ready(e) : e(x) : x.makeArray(e, this);
    ...
    function F() {
        C.removeEventListener("DOMContentLoaded", F), T.removeEventListener("load", F), x.ready()
    }
    ...
    }), x.ready.then = W.then, "complete" === C.readyState || "loading" !== C.readyState && !C.documentElement.doScroll ? T.setTimeout(x.ready) : (C.addEventListener("DOMContentLoaded", F), T.addEventListener("load", F));
        ...
        add: function(t, e, n, i, r) {
            ...
            if (m)
                for (n.handler && (n = (o = n).handler, r = o.selector), r && x.find.matchesSelector(ye, r), n.guid || (n.guid = x.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function(e) {
                    ...
                    }), u = (e = (e || "").match(P) || [""]).length; u--;) d = g = (a = we.exec(e[u]) || [])[1], p = (a[2] || "").split(".").sort(), d && (f = x.event.special[d] || {}, d = (r ? f.delegateType : f.bindType) || d, f = x.event.special[d] || {}, c = x.extend({
                    type: d,
                    origType: g,
                    data: i,
                    handler: n,
    ...
    function Le(n, i, r, o) {
        ...
        if (f && (t = (e = ve(i, n[0].ownerDocument, !1, n, o)).firstChild, 1 === e.childNodes.length && (e = t), t || o)) {
            ...
            if (a)
                for (u = s[s.length - 1].ownerDocument, x.map(s, Oe), c = 0; c < a; c++) l = s[c], ce.test(l.type || "") && !Y.access(l, "globalEval") && x.contains(u, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? x._evalUrl && x._evalUrl(l.src) : b(l.textContent.replace(Ne, ""), u, l))
        }
        return n
    }
    ...
    function Xe(e, t, n) {
        ...
        return s = s && (v.boxSizingReliable() || r === e.style[t]), ("auto" === r || !parseFloat(r) && "inline" === x.css(e, "display", !1, i)) && (r = e["offset" + t[0].toUpperCase() + t.slice(1)], s = !0), (r = parseFloat(r) || 0) + Ye(e, t, n || (o ? "border" : "content"), s, i, r) + "px"
    }
    ...
    x.extend({
        ...
        css: function(e, t, n, i) {
            var r, o, s, a = $(t);
            return Be.test(t) || (t = Ve(a)), (s = x.cssHooks[t] || x.cssHooks[a]) && "get" in s && (r = s.get(e, !0, n)), void 0 === r && (r = Me(e, t, i)), "normal" === r && t in Qe && (r = Qe[t]), "" === n || n ? (o = parseFloat(r), !0 === n || isFinite(o) ? o || 0 : r) : r
        }
    }), x.each(["height", "width"], function(e, a) {
        x.cssHooks[a] = {
            get: function(e, t, n) {
                if (t) return !Fe.test(x.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Xe(e, a, n) : re(e, Ue, function() {
                    return Xe(e, a, n)
                })
            },
            set: function(e, t, n) {
                var i, r = qe(e),
                    ...
                    s = n && Ye(e, a, n, o, r);
                return o && v.scrollboxSize() === r.position && (s -= Math.ceil(e["offset" + a[0].toUpperCase() + a.slice(1)] - parseFloat(r[a]) - Ye(e, a, "border", !1, r) - .5)), s && (i = te.exec(t)) && "px" !== (i[3] || "px") && (e.style[a] = t, t = x.css(e, a)), ze(0, t, s)
            }
        }
    ...
    function rt() {
        Ze && (!1 === C.hidden && T.requestAnimationFrame ? T.requestAnimationFrame(rt) : T.setTimeout(rt, x.fx.interval), x.fx.tick())
    }
    ...
    function lt(o, e, t) {
        ...
        for (function(e, t) {
                var n, i, r, o, s;
                for (n in e)
                    if (r = t[i = $(n)], o = e[n], Array.isArray(o) && (r = o[1], o = e[n] = o[0]), n !== i && (e[i] = o, delete e[n]), (s = x.cssHooks[i]) && "expand" in s)
    ...
    x.Animation = x.extend(lt, {
        ...
        prefilters: [function(e, t, n) {
            ...
            if ((l = !x.isEmptyObject(t)) || !x.isEmptyObject(d))
                for (i in f && 1 === e.nodeType && (n.overflow = [p.overflow, p.overflowX, p.overflowY], null == (u = m && m.display) && (u = Y.get(e, "display")), "none" === (c = x.css(e, "display")) && (u ? c = u : (ae([e], !0), u = e.style.display || u, c = x.css(e, "display"), ae([e]))), ("inline" === c || "inline-block" === c && null != u) && "none" === x.css(e, "float") && (l || (h.done(function() {
                        p.display = u
                    ...
                    for (i in g || ae([e]), Y.remove(e, "fxshow"), d) x.style(e, i, d[i])
    ...
    Ht.href = _t.href, x.extend({
        ...
        ajax: function(e, t) {
            ...
            if (m.data && m.processData && "string" != typeof m.data && (m.data = x.param(m.data, m.traditional)), Rt(jt, m, t, E), p) return E;
    ...
    x.ajaxSetup({
        ...
        if (s || "jsonp" === e.dataTypes[0]) return i = e.jsonpCallback = y(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(Qt, "$1" + i) : !1 !== e.jsonp && (e.url += (wt.test(e.url) ? "&" : "?") + e.jsonp + "=" + i), e.converters["script json"] = function() {
            ...
            void 0 === r ? x(T).removeProp(i) : T[i] = r, e[i] && (e.jsonpCallback = t.jsonpCallback, Ut.push(i)), o && y(r) && r(o[0]), o = r = void 0
        }), "script"
    ...
    }, x.isArray = Array.isArray, x.parseJSON = JSON.parse, x.nodeName = D, x.isFunction = y, x.isWindow = _, x.camelCase = $, x.type = w, x.now = Date.now, x.isNumeric = function(e) {
        var t = x.type(e);
...
function(e, t) {
    ...
    function i(e, t, n, i) {
        return q(t["offset" + e], t["scroll" + e], n["client" + e], n["offset" + e], n["scroll" + e], F() ? n["offset" + e] + i["margin" + ("Height" === e ? "Top" : "Left")] + i["margin" + ("Height" === e ? "Bottom" : "Right")] : 0)
    }
    ...
    function D(e, t) {
        ...
        if (c.marginTop = 0, c.marginLeft = 0, !n && i) {
            ...
            c.top -= l - f, c.bottom -= l - f, c.left -= u - h, c.right -= u - h, c.marginTop = f, c.marginLeft = h
        }
    ...
    function h(e, t, n, i) {
        var r, o, s, a, l, u, c, f = {
            ...
            h = E(e, t);
        if ("viewport" === i) o = (r = h).ownerDocument.documentElement, s = D(r, o), a = q(o.clientWidth, window.innerWidth || 0), l = q(o.clientHeight, window.innerHeight || 0), u = T(o), c = T(o, "left"), f = x({
            ...
            var d;
            "scrollParent" === i ? "BODY" === (d = _(y(t))).nodeName && (d = e.ownerDocument.documentElement) : d = "window" === i ? e.ownerDocument.documentElement : i;
            var p = D(d, h);
    ...
    for (var P = Math.min, H = Math.floor, q = Math.max, g = "undefined" != typeof window && "undefined" != typeof document, m = ["Edge", "Trident", "Firefox"], v = 0, R = 0; R < m.length; R += 1)
        if (g && 0 <= navigator.userAgent.indexOf(m[R])) {
            v = 1;
            break
        }
    var M, W = g && window.Promise ? function(e) {
            var t = !1;
            return function() {
        ...
        X = function() {
            function o(e, t) {
                ...
                }, this.update = W(this.update.bind(this)), this.options = Q({}, o.Defaults, i), this.state = {
                    isDestroyed: !1,
                    isCreated: !1,
                    scrollParents: []
        ...
        modifiers: {
                ...
                fn: function(e, i) {
                    ...
                    var n = i.priority,
                        ...
                        s = {
                            primary: function(e) {
                                var t = o[e];
                                return o[e] < r[e] && !i.escapeWithReference && (t = q(o[e], r[e])), U({}, e, t)
                            },
            ...
            arrow: {
                ...
                fn: function(e, t) {
                    ...
                    var r = e.placement.split("-")[0],
                        ...
                        d = l ? "bottom" : "right",
                        p = A(i)[u];
                    a[d] - p < s[f] && (e.offsets.popper[f] -= s[f] - (a[d] - p)), a[f] + p > s[d] && (e.offsets.popper[f] += a[f] + p - s[d]), e.offsets.popper = x(e.offsets.popper);
                    var g = a[f] + a[u] / 2 - p / 2,
                        m = b(e.instance.popper),
                        v = parseFloat(m["margin" + c], 10),
                        y = parseFloat(m["border" + c + "Width"], 10),
                        _ = g - e.offsets.popper[f] - v - y;
                    return _ = q(P(s[u] - p, _), 0), e.arrowElement = i, e.offsets.arrow = (U(n = {}, f, Math.round(_)), U(n, h, ""), n), e
                },
                element: "[x-arrow]"
            },
            flip: {
                ...
                fn: function(p, g) {
                    ...
                    var m = h(p.instance.popper, p.instance.reference, g.padding, g.boundariesElement),
                    ...
                    return b.forEach(function(e, t) {
                        ...
                        (s || f || d) && (p.flipped = !0, (s || f) && (v = b[t + 1]), d && (_ = "end" === (n = _) ? "start" : "start" === n ? "end" : n), p.placement = v + (_ ? "-" + _ : ""), p.offsets.popper = Q({}, p.offsets.popper, I(p.instance.popper, p.offsets.reference, p.placement)), p = O(p.instance.modifiers, p, "flip"))
                    }), p
                },
                behavior: "flip",
                padding: 5,
            ...
            inner: {
                ...
                fn: function(e) {
                    ...
                    return r[s ? "left" : "top"] = o[n] - (a ? r[s ? "width" : "height"] : 0), e.placement = N(t), e.offsets.popper = x(r), e
                }
            },
            hide: {
                order: 800,
            ...
            computeStyle: {
                ...
                fn: function(e, t) {
                    ...
                    var s, a, l = void 0 === o ? t.gpuAcceleration : o,
                        ...
                        p = j("transform");
                    if (a = "bottom" == h ? -u.height + f.bottom : f.top, s = "right" == d ? -u.width + f.right : f.left, l && p) c[p] = "translate3d(" + s + "px, " + a + "px, 0)", c[h] = 0, c[d] = 0, c.willChange = "transform";
                    else {
                        var g = "bottom" == h ? -1 : 1,
                            m = "right" == d ? -1 : 1;
...
function(e, t) {
    ...
    p(document).on(h.CLICK_DATA_API, '[data-dismiss="alert"]', y._handleDismiss(new y)), p.fn[o] = y._jQueryInterface, p.fn[o].Constructor = y, p.fn[o].noConflict = function() {
            ...
            return e.toggle = function() {
                ...
                if (n) {
                    ...
                    if (i) {
                        ...
                        else "checkbox" === i.type ? "LABEL" === this._element.tagName && i.checked === this._element.classList.contains(C) && (e = !1) : e = !1;
                        e && (i.checked = !this._element.classList.contains(C), p(i).trigger("change")), i.focus(), t = !1
                    }
                }
                this._element.hasAttribute("disabled") || this._element.classList.contains("disabled") || (t && this._element.setAttribute("aria-pressed", !this._element.classList.contains(C)), e && p(this._element).toggleClass(C))
            }, e.dispose = function() {
    ...
    p(document).on(L.CLICK_DATA_API, D, function(e) {
        var t = e.target;
        if (p(t).hasClass(x) || (t = p(t).closest(j)[0]), !t || t.hasAttribute("disabled") || t.classList.contains("disabled")) e.preventDefault();
        else {
        ...
        for (var e = [].slice.call(document.querySelectorAll(I)), t = 0, n = e.length; t < n; t++) {
            var i = e[t],
                r = i.querySelector(k);
            r.checked || r.hasAttribute("checked") ? i.classList.add(C) : i.classList.remove(C)
        }
        for (var o = 0, s = (e = [].slice.call(document.querySelectorAll(N))).length; o < s; o++) {
            var a = e[o];
    ...
    var H = "carousel",
        ...
        fe = function() {
            ...
            return e.next = function() {
                ...
                e || (this._isPaused = !0), this._element.querySelector(se) && (g.triggerTransitionEnd(this._element), this.cycle(!0)), clearInterval(this._interval), this._interval = null
            }, e.cycle = function(e) {
                ...
                p(this._element).off(R), p.removeData(this._element, q), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
                ...
                if (this._touchSupported) {
                    ...
                    p(this._element.querySelectorAll(oe)).on(V.DRAG_START, function(e) {
                        ...
                        return i(e)
                    }), this._element.classList.add(te)) : (p(this._element).on(V.TOUCHSTART, function(e) {
                        return t(e)
                ...
                if (r = e === U ? (n = J, i = Z, K) : (n = G, i = ee, $), l && p(l).hasClass(Y)) this._isSliding = !1;
                    ...
                    } else p(s).removeClass(Y), p(l).addClass(Y), this._isSliding = !1, p(this._element).trigger(f);
                    c && this.cycle()
                }
                ...
                return this.each(function() {
                    ...
                    if (e || (e = new o(this, t), p(this).data(q, e)), "number" == typeof i) e.to(i);
                ...
                if (t) {
                    ...
                    if (n && p(n).hasClass(z)) {
                        ...
                        r && (i.interval = !1), o._jQueryInterface.call(p(n), i), r && p(n).data(q).to(r), e.preventDefault()
                    }
                }
            }, s(o, null, [{
                key: "VERSION",
    ...
    p(document).on(V.CLICK_DATA_API, le, fe._dataApiClickHandler), p(window).on(V.LOAD_DATA_API, function() {
        for (var e = [].slice.call(document.querySelectorAll(ue)), t = 0, n = e.length; t < n; t++) {
            var i = p(e[t]);
            fe._jQueryInterface.call(i, i.data())
        }
    }), p.fn[H] = fe._jQueryInterface, p.fn[H].Constructor = fe, p.fn[H].noConflict = function() {
    ...
    var he = "collapse",
        ...
        De = function() {
            ...
            return e.toggle = function() {
                ...
                var e, t, n = this;
                if (!this._isTransitioning && !p(this._element).hasClass(_e) && (this._parent && 0 === (e = [].slice.call(this._parent.querySelectorAll(xe)).filter(function(e) {
                    ...
                    if (p(this._element).trigger(i), !i.isDefaultPrevented()) {
                        ...
                        p(this._element).removeClass(be).addClass(we), this._element.style[r] = 0, this._triggerArray.length && p(this._triggerArray).removeClass(Ee).attr("aria-expanded", !0), this.setTransitioning(!0);
                        var o = "scroll" + (r[0].toUpperCase() + r.slice(1)),
                            s = g.getTransitionDurationFromElement(this._element);
                        p(this._element).one(g.TRANSITION_END, function() {
                            p(n._element).removeClass(we).addClass(be).addClass(_e), n._element.style[r] = "", n.setTransitioning(!1), p(n._element).trigger(ye.SHOWN)
                ...
                if (!this._isTransitioning && p(this._element).hasClass(_e)) {
                    ...
                    if (p(this._element).trigger(t), !t.isDefaultPrevented()) {
                        ...
                        this._element.style[n] = this._element.getBoundingClientRect()[n] + "px", g.reflow(this._element), p(this._element).addClass(we).removeClass(be).removeClass(_e);
                        var i = this._triggerArray.length;
                        if (0 < i)
                            for (var r = 0; r < i; r++) {
                                var o = this._triggerArray[r],
                                    s = g.getSelectorFromElement(o);
                                if (null !== s) p([].slice.call(document.querySelectorAll(s))).hasClass(_e) || p(o).addClass(Ee).attr("aria-expanded", !1)
                            }
                        this.setTransitioning(!0);
                        this._element.style[n] = "";
                        var a = g.getTransitionDurationFromElement(this._element);
                        p(this._element).one(g.TRANSITION_END, function() {
                            e.setTransitioning(!1), p(e._element).removeClass(we).addClass(be).trigger(ye.HIDDEN)
                ...
                return (e = l({}, me, {}, e)).toggle = Boolean(e.toggle), g.typeCheckConfig(he, e, ve), e
    ...
    }), p.fn[he] = De._jQueryInterface, p.fn[he].Constructor = De, p.fn[he].noConflict = function() {
    ...
    var Ae = "dropdown",
        ...
        tt = function() {
            ...
            return e.toggle = function() {
                ...
                if (void 0 === e && (e = !1), !(this._element.disabled || p(this._element).hasClass(Pe) || p(this._menu).hasClass(He))) {
                    var t = {
                    ...
                    if (p(i).trigger(n), !n.isDefaultPrevented()) {
                        if (!this._inNavbar && e) {
                            ...
                            var r = this._element;
                            "parent" === this._config.reference ? r = i : g.isElement(this._config.reference) && (r = this._config.reference, void 0 !== this._config.reference.jquery && (r = this._config.reference[0])), "scrollParent" !== this._config.boundary && p(i).addClass(Fe), this._popper = new f(r, this._menu, this._getPopperConfig())
                        }
                        "ontouchstart" in document.documentElement && 0 === p(i).closest(Ke).length && p(document.body).children().on("mouseover", null, p.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), p(this._menu).toggleClass(He), p(i).toggleClass(He).trigger(p.Event(Le.SHOWN, t))
                    }
                }
            }, e.hide = function() {
                if (!this._element.disabled && !p(this._element).hasClass(Pe) && p(this._menu).hasClass(He)) {
                    var e = {
                            relatedTarget: this._element
                        },
                        t = p.Event(Le.HIDE, e),
                        n = u._getParentFromElement(this._element);
                    p(n).trigger(t), t.isDefaultPrevented() || (this._popper && this._popper.destroy(), p(this._menu).toggleClass(He), p(n).toggleClass(He).trigger(p.Event(Le.HIDDEN, e)))
                }
            }, e.dispose = function() {
                p.removeData(this._element, Ne), p(this._element).off(Ie), this._element = null, (this._menu = null) !== this._popper && (this._popper.destroy(), this._popper = null)
            }, e.update = function() {
                ...
                return e = l({}, this.constructor.Default, {}, p(this._element).data(), {}, e), g.typeCheckConfig(Ae, e, this.constructor.DefaultType), e
                ...
                var e = p(this._element.parentNode),
                    t = Ye;
                return e.hasClass(qe) ? (t = Ve, p(this._menu).hasClass(We) && (t = ze)) : e.hasClass(Re) ? t = Ge : e.hasClass(Me) ? t = Je : p(this._menu).hasClass(We) && (t = Xe), t
                ...
                return this.each(function() {
                    ...
                    if (e || (e = new u(this, "object" == typeof t ? t : null), p(this).data(Ne, e)), "string" == typeof t) {
                ...
                if (!e || 3 !== e.which && ("keyup" !== e.type || 9 === e.which))
                    for (var t = [].slice.call(document.querySelectorAll(Be)), n = 0, i = t.length; n < i; n++) {
                        ...
                        if (e && "click" === e.type && (s.clickEvent = e), o) {
                            var a = o._menu;
                            if (p(r).hasClass(He) && !(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && 9 === e.which) && p.contains(r, e.target))) {
                                var l = p.Event(Le.HIDE, s);
                                p(r).trigger(l), l.isDefaultPrevented() || ("ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), t[n].setAttribute("aria-expanded", "false"), o._popper && o._popper.destroy(), p(a).removeClass(He), p(r).removeClass(He).trigger(p.Event(Le.HIDDEN, s)))
                            }
                        }
                    }
                ...
                if ((/input|textarea/i.test(e.target.tagName) ? !(32 === e.which || 27 !== e.which && (40 !== e.which && 38 !== e.which || p(e.target).closest(Qe).length)) : je.test(e.which)) && (e.preventDefault(), e.stopPropagation(), !this.disabled && !p(this).hasClass(Pe))) {
                    var t = u._getParentFromElement(this),
                        n = p(t).hasClass(He);
                    if (n || 27 !== e.which)
                        if (n && (!n || 27 !== e.which && 32 !== e.which)) {
                            var i = [].slice.call(t.querySelectorAll($e)).filter(function(e) {
    ...
    p(document).on(Le.KEYDOWN_DATA_API, Be, tt._dataApiKeydownHandler).on(Le.KEYDOWN_DATA_API, Qe, tt._dataApiKeydownHandler).on(Le.CLICK_DATA_API + " " + Le.KEYUP_DATA_API, tt._clearMenus).on(Le.CLICK_DATA_API, Be, function(e) {
        e.preventDefault(), e.stopPropagation(), tt._jQueryInterface.call(p(this), "toggle")
    }).on(Le.CLICK_DATA_API, Ue, function(e) {
        e.stopPropagation()
    }), p.fn[Ae] = tt._jQueryInterface, p.fn[Ae].Constructor = tt, p.fn[Ae].noConflict = function() {
    ...
    var nt = "modal",
        ...
        Et = function() {
            function r(e, t) {
                this._config = this._getConfig(t), this._element = e, this._dialog = e.querySelector(mt), this._backdrop = null, this._isShown = !1, this._isBodyOverflowing = !1, this._ignoreBackdropClick = !1, this._isTransitioning = !1, this._scrollbarWidth = 0
            }
            var e = r.prototype;
            return e.toggle = function(e) {
                ...
                if (!this._isShown && !this._isTransitioning) {
                    ...
                    p(this._element).trigger(n), this._isShown || n.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), p(this._element).on(lt.CLICK_DISMISS, _t, function(e) {
                        return t.hide(e)
                ...
                if (e && e.preventDefault(), this._isShown && !this._isTransitioning) {
                    ...
                    if (p(this._element).trigger(n), this._isShown && !n.isDefaultPrevented()) {
                        ...
                        if (i && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), p(document).off(lt.FOCUSIN), p(this._element).removeClass(pt), p(this._element).off(lt.CLICK_DISMISS), p(this._dialog).off(lt.MOUSEDOWN_DISMISS), i) {
                ...
                this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), p(this._dialog).hasClass(ut) && i ? i.scrollTop = 0 : this._element.scrollTop = 0, n && g.reflow(this._element), p(this._element).addClass(pt), this._config.focus && this._enforceFocus();
                var r = p.Event(lt.SHOWN, {
                        relatedTarget: e
                    }),
                    o = function() {
                ...
                this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._isTransitioning = !1, this._showBackdrop(function() {
                    p(document.body).removeClass(ht), e._resetAdjustments(), e._resetScrollbar(), p(e._element).trigger(lt.HIDDEN)
                })
                ...
                if (this._isShown && this._config.backdrop) {
                    if (this._backdrop = document.createElement("div"), this._backdrop.className = ft, n && this._backdrop.classList.add(n), p(this._backdrop).appendTo(document.body), p(this._element).on(lt.CLICK_DISMISS, function(e) {
                            t._ignoreBackdropClick ? t._ignoreBackdropClick = !1 : e.target === e.currentTarget && t._triggerBackdropTransition()
                        }), n && g.reflow(this._backdrop), p(this._backdrop).addClass(pt), !e) return;
                    if (!n) return void e();
    ...
    }), p.fn[nt] = Et._jQueryInterface, p.fn[nt].Constructor = Et, p.fn[nt].noConflict = function() {
        ...
        for (var n = (new window.DOMParser).parseFromString(e, "text/html"), a = Object.keys(s), l = [].slice.call(n.body.querySelectorAll("*")), i = function(e, t) {
                ...
                r.forEach(function(e) {
                    (function(e, t) {
                        ...
                        if (-1 !== t.indexOf(n)) return -1 === Tt.indexOf(n) || Boolean(e.nodeValue.match(xt) || e.nodeValue.match(St));
            ...
            return e.enable = function() {
                ...
                if (this._isEnabled)
                    if (e) {
                        ...
                        if (p(this.getTipElement()).hasClass(Bt)) return void this._leave(null, this);
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    r.setAttribute("id", o), this.element.setAttribute("aria-describedby", o), this.setContent(), this.config.animation && p(r).addClass(Ft);
                    ...
                    var u = function() {
                        ...
                        var e = t._hoverState;
                        t._hoverState = null, p(t.element).trigger(t.constructor.Event.SHOWN), e === Mt && t._leave(null, t)
                    };
                ...
                var t = this,
                    ...
                    r = function() {
                        t._hoverState !== Rt && n.parentNode && n.parentNode.removeChild(n), t._cleanTipClass(), t.element.removeAttribute("aria-describedby"), p(t.element).trigger(t.constructor.Event.HIDDEN), null !== t._popper && t._popper.destroy(), e && e()
                    };
                if (p(this.element).trigger(i), !i.isDefaultPrevented()) {
                    if (p(n).removeClass(Bt), "ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), this._activeTrigger[Vt] = !1, this._activeTrigger[$t] = !1, this._activeTrigger[Kt] = !1, p(this.tip).hasClass(Ft)) {
                ...
                this.setElementContent(p(e.querySelectorAll(Ut)), this.getTitle()), p(e).removeClass(Ft + " " + Bt)
            }, e.setElementContent = function(e, t) {
                "object" != typeof t || !t.nodeType && !t.jquery ? this.config.html ? (this.config.sanitize && (t = Dt(t, this.config.whiteList, this.config.sanitizeFn)), e.html(t)) : e.text(t) : this.config.html ? p(t).parent().is(e) || e.empty().append(t) : e.text(p(t).text())
            }, e.getTitle = function() {
                ...
                var n = this.constructor.DATA_KEY;
                (t = t || p(e.currentTarget).data(n)) || (t = new this.constructor(e.currentTarget, this._getDelegateConfig()), p(e.currentTarget).data(n, t)), e && (t._activeTrigger["focusout" === e.type ? $t : Kt] = !1), t._isWithActiveTrigger() || (clearTimeout(t._timeout), t._hoverState = Mt, t.config.delay && t.config.delay.hide ? t._timeout = setTimeout(function() {
                ...
                return Object.keys(t).forEach(function(e) {
                    ...
                    show: e.delay,
                    hide: e.delay
                }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), g.typeCheckConfig(At, e, this.constructor.DefaultType), e.sanitize && (e.template = Dt(e.template, e.whiteList, e.sanitizeFn)), e
                ...
                null === e.getAttribute("x-placement") && (p(e).removeClass(Ft), this.config.animation = !1, this.hide(), this.show(), this.config.animation = t)
            }, i._jQueryInterface = function(n) {
                return this.each(function() {
                    var e = p(this).data(Nt),
                        t = "object" == typeof n && n;
                    if ((e || !/dispose|hide/.test(n)) && (e || (e = new i(this, t), p(this).data(Nt, e)), "string" == typeof n)) {
                        if (void 0 === e[n]) throw new TypeError('No method named "' + n + '"');
                        e[n]()
                    }
                })
    ...
    var Xt = "popover",
        ...
        cn = function(e) {
            ...
            return r.isWithContent = function() {
                ...
                "function" == typeof t && (t = t.call(this.element)), this.setElementContent(e.find(ln), t), e.removeClass(on + " " + sn)
    ...
    p.fn[Xt] = cn._jQueryInterface, p.fn[Xt].Constructor = cn, p.fn[Xt].noConflict = function() {
    ...
    var fn = "scrollspy",
        ...
        In = function() {
            function n(e, t) {
                var n = this;
                this._element = e, this._scrollElement = "BODY" === e.tagName ? window : e, this._config = this._getConfig(t), this._selector = this._config.target + " " + En + "," + this._config.target + " " + Cn + "," + this._config.target + " " + Sn, this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, p(this._scrollElement).on(vn.SCROLL, function(e) {
                    return n._process(e)
            ...
            return e.refresh = function() {
                ...
                p.removeData(this._element, hn), p(this._scrollElement).off(dn), this._element = null, this._scrollElement = null, this._config = null, this._selector = null, this._offsets = null, this._targets = null, this._activeTarget = null, this._scrollHeight = null
            }, e._getConfig = function(e) {
                if ("string" != typeof(e = l({}, gn, {}, "object" == typeof e && e ? e : {})).target) {
                    var t = p(e.target).attr("id");
                    t || (t = g.getUID(fn), p(e.target).attr("id", t)), e.target = "#" + t
                }
                ...
                n.hasClass(yn) ? (n.closest(xn).find(Dn).addClass(_n), n.addClass(_n)) : (n.addClass(_n), n.parents(wn).prev(En + ", " + Cn).addClass(_n), n.parents(wn).prev(Tn).children(En).addClass(_n)), p(this._scrollElement).trigger(vn.ACTIVATE, {
                    relatedTarget: t
                })
            }, e._clear = function() {
                ...
                return this.each(function() {
                    ...
                    if (e || (e = new n(this, "object" == typeof t && t), p(this).data(hn, e)), "string" == typeof t) {
                        if (void 0 === e[t]) throw new TypeError('No method named "' + t + '"');
                        e[t]()
                    }
                })
    ...
    p(window).on(vn.LOAD_DATA_API, function() {
        for (var e = [].slice.call(document.querySelectorAll(bn)), t = e.length; t--;) {
            var n = p(e[t]);
            In._jQueryInterface.call(n, n.data())
        }
    }), p.fn[fn] = In._jQueryInterface, p.fn[fn].Constructor = In, p.fn[fn].noConflict = function() {
    ...
    var kn = "bs.tab",
        ...
        Vn = function() {
            ...
            return e.show = function() {
                var n = this;
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && p(this._element).hasClass(Hn) || p(this._element).hasClass(qn))) {
                    var e, i, t = p(this._element).closest(Fn)[0],
                ...
                var i = this,
                    r = (!t || "UL" !== t.nodeName && "OL" !== t.nodeName ? p(t).children(Bn) : p(t).find(Un))[0],
                ...
                if (r && o) {
                    ...
                    p(r).removeClass(Mn).one(g.TRANSITION_END, s).emulateTransitionEnd(a)
                } else s()
            }, e._transitionComplete = function(e, t, n) {
                if (t) {
                    p(t).removeClass(Hn);
                    var i = p(t.parentNode).find($n)[0];
                    i && p(i).removeClass(Hn), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !1)
                }
                if (p(e).addClass(Hn), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0), g.reflow(e), e.classList.contains(Rn) && e.classList.add(Mn), e.parentNode && p(e.parentNode).hasClass(Pn)) {
                ...
                return this.each(function() {
                    var e = p(this),
                        t = e.data(kn);
                    if (t || (t = new i(this), e.data(kn, t)), "string" == typeof n) {
        ...
        si = function() {
            ...
            return e.show = function() {
                ...
                if (p(this._element).trigger(t), !t.isDefaultPrevented()) {
                    ...
                    var n = function() {
                        e._element.classList.remove(ni), e._element.classList.add(ti), p(e._element).trigger(Jn.SHOWN), e._config.autohide && (e._timeout = setTimeout(function() {
                            e.hide()
                        }, e._config.delay))
                    };
                    if (this._element.classList.remove(ei), g.reflow(this._element), this._element.classList.add(ni), this._config.animation) {
                ...
                clearTimeout(this._timeout), this._timeout = null, this._element.classList.contains(ti) && this._element.classList.remove(ti), p(this._element).off(Jn.CLICK_DISMISS), p.removeData(this._element, Yn), this._element = null, this._config = null
            }, e._getConfig = function(e) {
                return e = l({}, ri, {}, p(this._element).data(), {}, "object" == typeof e && e ? e : {}), g.typeCheckConfig(zn, e, this.constructor.DefaultType), e
            }, e._setListeners = function() {
                var e = this;
    ...
    p.fn[zn] = si._jQueryInterface, p.fn[zn].Constructor = si, p.fn[zn].noConflict = function() {
        return p.fn[zn] = Gn, si._jQueryInterface
    }, e.Alert = y, e.Button = P, e.Carousel = fe, e.Collapse = De, e.Dropdown = tt, e.Modal = Et, e.Popover = cn, e.Scrollspy = In, e.Tab = Vn, e.Toast = si, e.Tooltip = Yt, e.Util = g, Object.defineProperty(e, "__esModule", {
        value: !0
    })
});